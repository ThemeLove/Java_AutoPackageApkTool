...
//			(4)签名、优化生成最终包
			...
			String zipAlignPath=TOOLS_PATH+FILE_SEPARATOR+"zipalign"+FILE_SEPARATOR+"zipalign";
//			String zipAlignPath=apktoolVersion.getPath()+FILE_SEPARATOR+"zipalign.exe";
			...
			CmdUtil.exeCmdWithLog(generateChannelApkCommand, null, new File(TOOLS_PATH+FILE_SEPARATOR+"zipalign"));
